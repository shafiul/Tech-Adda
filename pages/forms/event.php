<form  enctype="multipart/form-data" class="form-stacked validationForm" action="<?php echo BASE_URL . '?page='.$action.'&mode=' . $mode; ?>" method="post">
    <fieldset>
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <textarea class="span7" id="summary" name="summary" rows="7" cols="50"><?php echo ViewHelper::getInput('summary') ?></textarea>
            </div>
        </div>
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <input class="span7 error" id="location" name="location" value="<?php echo ViewHelper::getInput('location') ?>" size="30" type="text">
            </div>
        </div>
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <input class="span7 url" id="href" name="href" value="<?php echo ViewHelper::getInput('href') ?>" size="30" type="text">
            </div>
        </div>
        ...
        <div class="clearfix">
            ...
            <div class="inline-inputs">
                <input class="small datepicker date" id="start_date" name="start_date" value="<?php echo ViewHelper::getInput('start_date') ?>" type="text"> to
                <input class="small datepicker date" id="end_date" name="end_date" value="<?php echo ViewHelper::getInput('end_date') ?>" type="text">
